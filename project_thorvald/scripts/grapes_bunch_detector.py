...
class image_converter:
    ...
    #Draw a bounding box around the grapes
    ...
    def image_callback(self, data):
        ...
        #Perform appropriate morphological operations to help the robot detect the grapes better
        kernel = numpy.ones((5,5),numpy.uint8)
        ...
        if(exec_once==0):
            #Count the grapes only if it between two beacons
            if(b_cnt==2):
                contours,hierarchy = cv2.findContours(mask, 1, 2) 
